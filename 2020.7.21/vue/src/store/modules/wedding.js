...
var searchdata=[ctx.state.choosedform,myid];
  ...
  //婚戒购物车     
  addtocarthunjie(ctx){ 
    let guid=(JSON.parse(sessionStorage.user)[0]).id
    ...
    axios.post("/api/addtocart1.do",{guid:guid,gname:gname,gletteringinner:'',gLetteringtime:'',gprice:gprice,handsize:handsize,gnamenan:'',gnamenv:'',handsizenan:'',handsizenv:''})
