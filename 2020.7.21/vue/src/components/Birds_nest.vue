      ...
      <el-col :span="21" :offset="3">
        <div>
          ...
          <div class="title">
            ...
            <router-link to="/Birds_nest" class="myspan myfrom"
              >我的鸟巢</router-link
            >
    ...
    <el-row>
      <el-col :span="2" :offset="3" class="myborder myright myleft">
        <router-link
          ...
          id="birds"
        >
          <a href="#" class="myfrom mycolor" id="myc" @click="chakan('myBirds')"
            >我的鸟巢</a
          >
        </router-link>
        <nav>
          ...
          <el-row class="myinte">
            ...
            <el-col :span="8" class="myintegral">
              <div class="myuser">
                ...
                <router-link :to="{ path: '/user' }" class="mychange"
                  >修改资料</router-link
                >
              </div>
              <div class="myuser">
            ...
            >
              <template slot-scope="scope">
                <router-link
                  ...
                  type="text"
                  size="small"
                  ><a href="" @click="chakan('myview')" class="mybutton"
                    >立即支付</a
                  >
                  <a href="" @click="chakan('myview')" class="mybutton"
                    >查看详情</a
