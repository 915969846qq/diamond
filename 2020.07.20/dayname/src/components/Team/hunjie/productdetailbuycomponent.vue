...
<!--预览图片-->
    <el-col :span="10" :offset="1" class="img-preview">
      <div class="bigimg-wrap yincang" style="background-color:#fff;">
        <img class="bigimg" :src="middleimg" alt="" style="height: 800px;width: 800px"></div>
      <div>
       <div class="middle-img-wrap">
        ...
        <div class="small-img-preview">
          ...
          <li><img class="small-img " :src="'/api/images/goodnight/23320_399.jpg'" alt=""></li>
          <li><img class="small-img" :src="'/api/images/goodnight/23320_388.jpg'" alt=""></li>
          <li><img class="small-img" :src="'/api/images/goodnight/23320_312.jpg'" alt=""></li>
          <li><img class="small-img" :src="'/api/images/goodnight/23320_313.jpg'" alt=""></li>
          <li><img class="small-img" :src="'/api/images/goodnight/23320_314.jpg'" alt=""></li>
...
<!--    右边戒指参数信息-->
    <el-col :span="9" :offset="4" class="top-right-buy">
      ...
      <div>
        ...
        <span>售出 <span class="red">{{$store.state.wedding.productbuy.sellnum}}</span></span>
        <span >评论  <span class="red">{{$store.state.wedding.productbuy.commentnum}}</span></span>

      </div>
         </div>
      <div class="buydetail">
        <div><span>品名</span><span>{{$store.state.wedding.productbuy.material}}钻石戒指</span></div>
        <div><span>材质</span><span>{{$store.state.wedding.productbuy.materialdetail}}</span></div>
        <div><span>手寸</span><span>{{$store.state.wedding.productbuy.palmsize}}</span>
          <span class="count-palmsize" @click="myshu()">如何测手寸</span></div>
        <div><span>钻石</span>
        ...
        <div v-if="$store.state.wedding.productbuy.expressdate!=undefined"><span>配送</span><span>{{$store.state.wedding.productbuy.expressdate.substring(0,10)}}</span></div>
      </div>

      <div>
        <div>
        <span>更多</span><a @click="gotosame" style="cursor: pointer;" class="more-product-same">选择其它同款现货</a>
      </div></div>
      <div class="btn">
