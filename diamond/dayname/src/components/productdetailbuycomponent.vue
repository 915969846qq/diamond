  ...
  <el-row class="productbuy">
    ...
    <el-col :span="8" :offset="4" class="top-right-buy">
      ...
      <div>
        <div>
          <span>材质</span>
          <router-link to="" class="more-product">铂950</router-link>
          <router-link to="" class="more-product">黄18K金</router-link>
          <router-link to="" class="more-product">红18K金</router-link>
          <router-link to="" class="more-product">白18K金</router-link>
        </div>
        <div>
          <span>手寸</span>
